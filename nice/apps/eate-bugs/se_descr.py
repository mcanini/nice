...
class SymExecApp:
    APP_NAME="eate NOX app"
    NORMALIZE_MODS = ["eateb.py"] # list of single modules (filenames with relative path from current dir) to normalize
    ...
    def reset_callback(self):
        self.app = __import__("eateb", fromlist="eate_app")
